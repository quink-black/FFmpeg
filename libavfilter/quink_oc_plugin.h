...
public:
    ...
    /**
     * Return the number of inputs this plugin expects.
     * For multi-input mode (N:1), return N.
     */
    virtual int numInputs() const = 0;

    /**
     * Return the number of outputs this plugin produces.
     * For multi-output mode (1:N), return N.
     * Note: Multi-input + multi-output (N:M, N>1 && M>1) is NOT supported.
     */
